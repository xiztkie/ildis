...
use frontend\models\search\MasukanMasyarakatSearch;
...
/**
 * KomentarController implements the CRUD actions for MasukanMasyarakat model.
 */
    ...
    public function actionCreate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()))
        {
            ...
            */
            ...
            if ($model->save()) 
            {
                Yii::$app->session->setFlash('success', 'Komentar anda terkait rancangan peraturan ini telah berhasil, terima kasih.....');
                return $this->redirect(['rancangan/view', 'id' => $id]);
            } else 
            {
                //Yii::$app->session->setFlash('error', 'Data Masukan Masyarakat Gagal ditambahkan, periksa kembali ');
