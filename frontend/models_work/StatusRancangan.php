...
/**
 * This is the model class for table "status_rancangan".
 *
 * @property int $id
 ...
 */
class StatusRancangan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['is_publish', 'urutan', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        return $this->hasMany(Rancangan::className(), ['status_rancangan_id' => 'id']);
    }
