...
/* @var $searchModel frontend\models\search\MasukanMasyarakatSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Masukan Masyarakat';
    ...
    <div class="box-body table-responsive no-padding">
        ...
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data '.'Masukan Masyarakat'.'</h3>',
            ],
            'toolbar' =>  [
