    ...
    <?php $form = ActiveForm::begin([
          ...
          <div class="box box-primary box-solid">
            <div class="box-header with-border">
              <b>Form Ubah Data Rancangan</b>
            
            </div>

            <div class="box-body">
                <?= $form->field($model, 'tahapan_rancangan')->dropDownList([ 'Perencanaan' => 'Perencanaan', 'Penyusunan' => 'Penyusunan', 'Pembahasan' => 'Pembahasan', ], ['prompt' => '']) ?>

<?= $form->field($model, 'nama_rancangan')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'jenis_rancangan')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'tahun')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'program')->textInput() ?>

<?= $form->field($model, 'pemrakarsa')->textInput() ?>

<?= $form->field($model, 'status')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'is_publish')->textInput() ?>

<?= $form->field($model, 'materi_muatan')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'keterangan')->textarea(['rows' => 6]) ?>

<?= $form->field($model, 'file_rancangan')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'file_naskah_akademik')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'tanggal_awal_publish')->textInput() ?>

<?= $form->field($model, 'tanggal_akhir_publish')->textInput() ?>
...
<?= $form->field($model, 'peraturan_id')->textInput(['maxlength' => true]) ?>
