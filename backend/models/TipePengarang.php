...
/**
 * This is the model class for table "tipe_pengarang".
 *
 * @property int $id
 ...
 */
class TipePengarang extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'status', 'created_by', 'updated_by'], 'string', 'max' => 255],
    ...
    {
        return $this->hasMany(DataPengarang::className(), ['tipe_pengarang' => 'id']);
    }
