...
/**
 * This is the model class for table "pola_eksemplar".
 *
 * @property int $id
 ...
 */
class PolaEksemplar extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['pattern', 'prefix', 'suffix', 'length', 'status'], 'required'],
            [['created_by', 'updated_by'], 'integer'],
            [['created_at', 'updated_at'], 'safe'],
            [['pattern', 'prefix', 'suffix', 'length'], 'string', 'max' => 100],
