...
/* @var $searchModel backend\models\UserMemberSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'User Member';
    ...
    <div class="box-body table-responsive no-padding">
        ...
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data '.'User Member'.'</h3>',
            ],
            'toolbar' =>  [
