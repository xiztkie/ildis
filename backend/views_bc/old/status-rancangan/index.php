...
/* @var $searchModel backend\models\search\StatusRancanganSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Status Rancangan';
    ...
    <div class="box-body table-responsive no-padding">
        ...
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data '.'Status Rancangan'.'</h3>',
            ],
            'toolbar' =>  [
