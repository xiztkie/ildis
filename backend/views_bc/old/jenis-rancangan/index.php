...
/* @var $searchModel backend\models\search\JenisRancanganSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Jenis Rancangan';
    ...
    <div class="box-body table-responsive no-padding">
        ...
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data '.'Jenis Rancangan'.'</h3>',
            ],
            'toolbar' =>  [
