...
/* @var $model backend\models\MasukanMasyarakat */
    ...
    <?php $form = ActiveForm::begin([
          ...
          <div class="box box-primary box-solid">
            <div class="box-header with-border">
              <b>Form Tambah Data Masukan Masyarakat</b>
            
            </div>

            <div class="box-body">
                <?= $form->field($model, 'rancangan_id')->textInput() ?>
...
<?= $form->field($model, 'masukan_mewakili')->dropDownList([ 'Pribadi' => 'Pribadi', 'Instansi' => 'Instansi', ], ['prompt' => '']) ?>
