...
/* @var $searchModel backend\models\TipePengarangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tipe Pengarang';
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Tipe Pengarang' . '</h3>',
        ],
        'toolbar' =>  [
