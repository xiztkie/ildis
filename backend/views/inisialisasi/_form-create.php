    ...
    <?php $form = ActiveForm::begin([
          ...
          <div class="box box-primary box-solid">
            <div class="box-header with-border">
              <b>Form Tambah Data Inisialisasi</b>
            
            </div>

            <div class="box-body">
                <?= $form->field($model, 'nama_inisialisasi')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'gmd')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'tipe_koleksi')->textInput(['maxlength' => true]) ?>
...
<?= $form->field($model, 'tanggal_dimulai')->textInput() ?>
