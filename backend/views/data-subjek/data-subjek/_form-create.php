    ...
    <?php $form = ActiveForm::begin([
          ...
          <div class="box box-primary box-solid">
            <div class="box-header with-border">
              <b>Form Tambah Data Data Subyek</b>
...
<?= $form->field($model, 'subyek')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'tipe_subyek')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'jenis_subyek')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'status')->textInput(['maxlength' => true]) ?>

<?= $form->field($model, 'integrasi')->textInput() ?>
