...
/* @var $searchModel backend\models\search\PemrakarsaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Pemrakarsa';
    ...
    <div class="box-body table-responsive no-padding">
        ...
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading'=> '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data '.'Pemrakarsa'.'</h3>',
            ],
            'toolbar' =>  [
