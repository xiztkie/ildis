...
/* @var $searchModel backend\models\UrusanPemerintahanSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Urusan Pemerintahan';
...
<div class="box-body table-responsive no-padding">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> Data ' . 'Urusan Pemerintahan' . '</h3>',
        ],
        'toolbar' =>  [
