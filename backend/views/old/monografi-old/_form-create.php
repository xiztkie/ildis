...
?>
    ...
    <div class="section">
        ...
        <?= $form->field($model, 'tempat_terbit')->textInput(['maxlength' => true])->label('Tempat Terbit') ?>
        ...
        <?= $form->field($model, 'klasifikasi')->dropDownList(
                \yii\helpers\ArrayHelper::map(\backend\models\Klasifikasi::find()->asArray()->all(), 'name', 'name'),
                [
                    'prompt'=>'--Silahkan Pilih--', 
                ])->label('Bahasa'); 
        ?>
