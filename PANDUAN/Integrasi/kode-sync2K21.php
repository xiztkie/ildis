...
$username = "jdihpuja";//diisi nama user db
$password = "Flyn4UGVsW1eh1t";//diisi password db
$dbname = "jdih_puja_11082024";//diisi nama database
$varjson = array();
...
// $row_array->urlDetailPeraturan='http://127.0.0.1/puncakjayakab/dokumen/view?id='.$row["sc_id"]; //berisi url halaman detail peraturan
$row_array->urlDetailPeraturan='https://jdih.puncakjayakab.go.id/puncakjayakabuuuuuu/dokumen/view?id='.$row["sc_id"]; //berisi url halaman detail peraturan
